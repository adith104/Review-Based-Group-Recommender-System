...
def process_raw_data(in_path="data/Digital_Music.json", out_path="data/reviews.json"):
    """
    ...
    # print (ROOT_DIR.joinpath(in_path))
    ...
    uniqueUserID = df["userID"].unique()
    uniqueUserID = np.sort (uniqueUserID)[:1000]
    mask = df["userID"].isin (uniqueUserID)
    df = df[mask]
...
if __name__ == "__main__":
    ...
    save_review_dict(all_data, word_vec, "next")
